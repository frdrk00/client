  ...
  return (
    <div className="w-full flex items-center justify-between gap-3">
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        >
          <BsFillBellFill className="text-gray-400 tex-xl" />
        </motion.div>
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <motion.div
            onClick={signOut}
            {...buttonClick}
            className="w-10 h-10 rounded-md cursor-pointer b-lightOverlay backdrop-blur-md shadow-md flex items-center justify-center"
          >
